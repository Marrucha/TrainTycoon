                        ...
                        <div style={{ display: 'flex', gap: 6, marginBottom: 12 }}>
                            {['daily', 'monthly'].map(v => (
                                <button key={v} onClick={() => setView(v)}
                                    style={{ background: view === v ? '#1a3a1a' : 'rgba(255,255,255,0.04)', border: `1px solid ${view === v ? '#2ecc71' : '#333'}`, color: view === v ? '#2ecc71' : '#888', borderRadius: 4, padding: '4px 12px', fontSize: 11, cursor: 'pointer' }}>
