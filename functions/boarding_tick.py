"""boarding_tick.py — minutowa symulacja boardingu.

Zawiera:
  - module-level cache miast i pociągów bazowych
  - run_boarding_tick()      — główna pętla co-minutowa
  - _process_stop_event()   — mutuje demand/transfer per przystanek
  - helpers: _calc_total_seats, _deep_copy_demand, _deep_copy_current, _add_delay
"""
